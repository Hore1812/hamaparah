    ...
    function renderizarTablaDobleEntrada(data) {
        ...
        for (const contrato in contratos) {
            ...
            estadosArray.forEach(estado => {
                ...
                const porcentaje = contratos[contrato].horas_planificadas > 0 ? (horas / parseFloat(contratos[contrato].horas_planificadas) * 100) : 0;
        ...
        estadosArray.forEach((estado, index) => {
            ...
            const totalPorcentaje = totalHorasPlanificadas > 0 ? (totalHoras / totalHorasPlanificadas * 100).toFixed(2) : "0.00";
