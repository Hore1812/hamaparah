...
<div class="container-fluid mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
 <?php if (isset($_SESSION['tipo_usuario']) && ($_SESSION['tipo_usuario'] == 1 || $_SESSION['tipo_usuario'] == 1)): ?>
<a href="planificaciones.php" class="btn btn-success me-2">
                <i class="fas fa-file-contract me-2"></i>Gestionar Planificaiones
                </a>
<?php endif; ?>
